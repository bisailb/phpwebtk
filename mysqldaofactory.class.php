...
class MysqlDaoFactory extends DaoFactory {
	// Private members
	private static $MysqlDaoFactory = null;
	private $dsn;
	/**
	 ...
	 * @static
	 *
	 * @return MysqlDaoFactory object instance
	 */
	public static function GetInstance() {
		if (empty ( MysqlDaoFactory::$MysqlDaoFactory )) {
			MysqlDaoFactory::$MysqlDaoFactory = new MysqlDaoFactory ();
		}
		return (MysqlDaoFactory::$MysqlDaoFactory);
	}
	/**
	 ...
	 *
	 * @access public
	 * @return MysqlSampleDao object instance
	 */
