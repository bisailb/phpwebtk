...
class MysqliDaoFactory extends DaoFactory {
	// Private members
	private static $MysqliDaoFactory;
	private $dsn;
	/**
	 ...
	 * @static
	 *
	 * @return MysqliDaoFactory object instance
	 */
	public static function GetInstance() {
		$MysqliDaoFactory = null;
		if (empty ( MysqliDaoFactory::$MysqliDaoFactory )) {
			MysqliDaoFactory::$MysqliDaoFactory = new MysqliDaoFactory ();
		}
		return (MysqliDaoFactory::$MysqliDaoFactory);
	}
	/**
	 ...
	 *
	 * @access public
	 * @return MysqliSampleDao object instance
	 */
	public function GetSampleDao() {
		return new MysqliSampleDao ( $this->dsn );
	}
}
?>
